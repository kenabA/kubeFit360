...
import fitnessCoach from "@/assets/website/images/About/fitnessCoach.jpg";
import gymBg from "@/assets/website/images/About/deadlifting.webp";
import Breadcrumbs from "@/components/breadcrumbs/Breadcrumbs";

export default function About() {
  return (
    <section id="services" className="uni-container py-12">
